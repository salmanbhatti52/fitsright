...
class MeasuementInchesTabbarDetail extends StatefulWidget {
  const MeasuementInchesTabbarDetail({super.key});

  @override
  State<MeasuementInchesTabbarDetail> createState() =>
      _MeasuementInchesTabbarDetailState();
}

class _MeasuementInchesTabbarDetailState
    extends State<MeasuementInchesTabbarDetail> {
  @override
